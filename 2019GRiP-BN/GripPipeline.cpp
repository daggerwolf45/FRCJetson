...
void GripPipeline::Process(cv::Mat& source0){
	...
	double hsvThresholdHue[] = {144.06474820143885, 163.33333333333334};
	double hsvThresholdSaturation[] = {0.0, 18.88888888888888};
	double hsvThresholdValue[] = {185.74640287769782, 192.75252525252523};
	hsvThreshold(hsvThresholdInput, hsvThresholdHue, hsvThresholdSaturation, hsvThresholdValue, this->hsvThresholdOutput);
	//Step Blur0:
	//input
	cv::Mat blur0Input = hsvThresholdOutput;
	BlurType blur0Type = MEDIAN;
	double blur0Radius = 2.7027027027027026;  // default Double
	blur(blur0Input, blur0Type, blur0Radius, this->blur0Output);
	//Step Blur1:
	//input
	cv::Mat blur1Input = blur0Output;
	BlurType blur1Type = BOX;
	double blur1Radius = 0.9009009009009009;  // default Double
	blur(blur1Input, blur1Type, blur1Radius, this->blur1Output);
	//Step Find_Contours0:
	//input
	cv::Mat findContoursInput = blur1Output;
	...
	double filterContoursSolidity[] = {89.92805755395683, 100.0};
	double filterContoursMaxVertices = 109.0;  // default Double
	double filterContoursMinVertices = 17.0;  // default Double
	double filterContoursMinRatio = 0.0;  // default Double
	double filterContoursMaxRatio = 30.0;  // default Double
